...
def plot_reward(axis, FLOW_A, LIMIT, VALUES, RANDOM=[], SIMPLE=[], YLIM=[None,None], LOC="best", averages=True):
...
def plot_length(axis, FLOW_A, LIMIT, VALUES, RANDOM=[], SIMPLE=[], YLIM=[0,None], LOC="best", averages=True):
...
def plot_coins(axis, FLOW_A, LIMIT, VALUES, RANDOM=[], SIMPLE=[], YLIM=[0,None], LOC="best", averages=True):
    ...
    if len(RANDOM) > 0:
        plot_constant(axis, RANDOM[1], VALUES, "y--", RANDOM[10]+": {:.1f}".format(RANDOM[1]))
    if len(SIMPLE) > 0:
        plot_constant(axis, SIMPLE[1], VALUES, "c--", "Simple Agent: {:.1f}".format(SIMPLE[1]))
...
def plot_crates(axis, FLOW_A, LIMIT, VALUES, RANDOM=[], SIMPLE=[], YLIM=[0,None], LOC="best", averages=True):
...
def plot_points(axis, FLOW_A, LIMIT, VALUES, RANDOM=[], SIMPLE=[], YLIM=[0,None], LOC="best", averages=True):
    """ Plot collected points per round.
    """
    ...
    if len(RANDOM) > 0:
        plot_constant(axis, RANDOM[4], VALUES, "y--", RANDOM[10]+": {:.1f}".format(RANDOM[4]))
    if len(SIMPLE) > 0:
        plot_constant(axis, SIMPLE[4], VALUES, "c--", "Simple Agent: {:.1f}".format(SIMPLE[4]))
...
def plot_kills(axis, FLOW_A, LIMIT, VALUES, RANDOM=[], SIMPLE=[], YLIM=[0,None], LOC="best", averages=True):
    """ Plot killed enemies per round.
    """
    ...
    if len(RANDOM) > 0:
        plot_constant(axis, RANDOM[5], VALUES, "y--", RANDOM[10]+": {:.2f}".format(RANDOM[5]))
    if len(SIMPLE) > 0:
        plot_constant(axis, SIMPLE[5], VALUES, "c--", "Simple Agent: {:.2f}".format(SIMPLE[5]))
...
def plot_suicides(axis, FLOW_A, LIMIT, VALUES, RANDOM=[], SIMPLE=[], YLIM=[0,1], LOC="best",long=False, averages=True):
    """ Plot suicides per round.
    """
    if long:
        plot_values(axis, FLOW_A[1][0][:,13], "b:", "Suicides")
...
def plot_killed(axis, FLOW_A, LIMIT, VALUES, RANDOM=[], SIMPLE=[], YLIM=[0,1], LOC="best",long=False, averages=True):
    """ Plot killed by enemies per round.
    """
    if long:
        plot_values(axis, FLOW_A[1][0][:,14], "b:", "Killed")
...
def plot_survived(axis, FLOW_A, LIMIT, VALUES, RANDOM=[], SIMPLE=[], YLIM=[0,1], LOC="best",long=False, averages=True):
    """ Plot survived per round.
    """
    if long:
        plot_values(axis, FLOW_A[1][0][:,16], "b:", "Durvived")
...
def plot_opp_elim(axis, FLOW_A, LIMIT, VALUES, RANDOM=[], SIMPLE=[], YLIM=[0,None], LOC="best"):
    """ Plot eliminated opponents per round.
    """
...
def plot_ONLY_CRATE(FLOW_A, LIMIT, VALUES, MEMORY, RANDOM, CONFIG, save_perf, SIMPLE=[], save=False, save_name="PerformanceOnlyCrate", both=False, size=(46.8,33.1)):
    ...
    label_last_axis(axes[3,1],"Number of rounds")
...
def plot_ONLY_CRATE_LONG(FLOW_A, LIMIT, VALUES, MEMORY, RANDOM, CONFIG, save_perf, SIMPLE=[], save=False, save_name="PerformanceOnlyCrateLong", both=False, size=(23.4,66.2)):
    ...
    label_last_axis(axes[7],"Number of rounds")
...
def plot_CRATE(FLOW_A, LIMIT, VALUES, RANDOM, CONFIG, save_perf, SIMPLE=[], save=False, save_name="PerformanceCrate", both=False, size=(46.8,33.1)):
    ...
    plot_coins(axes[2,0], FLOW_A, LIMIT, VALUES, RANDOM, SIMPLE)
    plot_length(axes[3,0], FLOW_A, LIMIT, VALUES, RANDOM, SIMPLE)
    label_last_axis(axes[3,0],"Number of rounds")
...
def plot_COIN(FLOW_A, LIMIT, VALUES, RANDOM, CONFIG, save_perf, SIMPLE=[], save=False, save_name="PerformanceCoin", both=False, size=(33.1,23.4)):
    ...
    label_last_axis(axes[2,0],"Number of rounds")
    ...
    label_last_axis(axes[2,1],"Number of rounds")
...
def plot_ALL_LONG(FLOW_A, LIMIT, VALUES, MEMORY, RANDOM, CONFIG, save_perf, SIMPLE=[], save=False, save_name="PerformanceAllLong", both=False, size=(23.4,66.2)):
    ...
    label_last_axis(axes[13],"Number of rounds")
    
    if save: plt.savefig(save_perf+"/"+save_name+".pdf", dpi=150, format="pdf")

def plot_ALL_SHORT(FLOW_A, LIMIT, VALUES, MEMORY, RANDOM, CONFIG, save_perf, SIMPLE=[], save=False, save_name="PerformanceAllShort", both=False, size=(23.4,66.2)):
    """ Plot all.
    """
    ...
    plot_survived(axes[8], FLOW_A, LIMIT, VALUES, RANDOM, SIMPLE)
    plot_length(axes[9], FLOW_A, LIMIT, VALUES, RANDOM, SIMPLE)
    label_last_axis(axes[9],"Number of rounds")
    
    if save: plt.savefig(save_perf+"/"+save_name+".pdf", dpi=150, format="pdf")

def plot_ALL_SHORTNR(FLOW_A, LIMIT, VALUES, MEMORY, RANDOM, CONFIG, save_perf, SIMPLE=[], save=False, save_name="PerformanceAllShortNR", both=False, size=(23.4,66.2)):
    """ Plot all.
    """
    fig, axes = plt.subplots(9)
    fig.set_size_inches(size)
    
    plot_points(axes[0], FLOW_A, LIMIT, VALUES, RANDOM, SIMPLE)
    plot_kills(axes[1], FLOW_A, LIMIT, VALUES, RANDOM, SIMPLE)
    plot_crates(axes[2], FLOW_A, LIMIT, VALUES, RANDOM, SIMPLE)
    plot_coins(axes[3], FLOW_A, LIMIT, VALUES, RANDOM, SIMPLE)
    plot_opp_elim(axes[4], FLOW_A, LIMIT, VALUES, RANDOM, SIMPLE)
    plot_suicides(axes[5], FLOW_A, LIMIT, VALUES, RANDOM, SIMPLE)
    plot_killed(axes[6], FLOW_A, LIMIT, VALUES, RANDOM, SIMPLE)
    plot_survived(axes[7], FLOW_A, LIMIT, VALUES, RANDOM, SIMPLE)
    plot_length(axes[8], FLOW_A, LIMIT, VALUES, RANDOM, SIMPLE)
    label_last_axis(axes[8],"Number of rounds")
    
    if save: plt.savefig(save_perf+"/"+save_name+".pdf", dpi=150, format="pdf")

def plot_length_final(axis, FLOW_A, LIMIT, VALUES, RANDOM=[], SIMPLE=[], YLIM=[0,None], LOC="best", averages=True):
    """ Plot for the length of one round. Axis must be part of plt.subplots!
    """
    plot_values(axis, FLOW_A[1][0][:,19], "b:", "Length")
    if averages:
        ...
        plot_values(axis, FLOW_A[3][0][:,19], "m-", "Average Length over {} Rounds".format(FLOW_A[0][1]), FLOW_A[0][1])
    if len(RANDOM) > 0:
        plot_constant(axis, RANDOM[3], VALUES, "m--", RANDOM[10])
    if len(SIMPLE) > 0:
        plot_constant(axis, SIMPLE[3], VALUES, "g--", "Simple Agent")
    if np.max(FLOW_A[1][0][:,19])>0.7*VALUES[2]:
        plot_constant(axis, VALUES[2], VALUES, "k:", "MAX")
    axis.set_title("Length of one Round",size=20)
    axis.legend(loc=LOC)
